            ...
            <div className="self-stretch flex flex-col justify-between items-center">
                ...
                <div className="self-center flex flex-col justify-between gap-40 w-3/5 mt-20 mb-20">
                  <div className="flex flex-col gap-8 items-center">
                    <div className="self-stretch relative flex flex-col items-center pb-16 px-12">
                      <div className="text-center text-xl font-['DM_Sans'] font-medium leading-[32px] text-white absolute top-[147.13623046875px] left-0 h-24 w-full">
